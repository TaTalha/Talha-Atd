# decompile by Talha Atd
# source code by Talha Atd
...
def reg():
    ...
    print ''
    print ''
    print '\x1b[1;92m  [Connected With Talha Servers]'
    print ''
...
def reg2():
    ...
    print ''
    print '\x1b[1;96m '
    print ' \xe2\x80\xa2 THIS TOOL IS COMPLETELY CODED BY TALHA \xe2\x80\xa2 '
    time.sleep(5)
    login()
...
def menu():
    ...
    print ''
    print 47 * '-'
    print ' \x1b[1;91m          Main Ahm Tha'
    print '         Yhi To Wahm Tha'
    print '\x1b[1;97m'
    print 47 * '-'
    print ''
    print ' [1] START'
    print ' [2] FOLLOW TALHA ON FB '
...
def menu_option():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://www.facebook.com/rinkukumar.kumar.7982780')
        menu()
    elif select == '3':
        os.system('xdg-open https://www.facebook.com/rinkukumar.kumar.7982780')
        menu()
